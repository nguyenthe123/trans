...
def download_image_from_google(word):
    """ This function will down load word's image from Google"""
    google_crawler.crawl(keyword=word, filters=filters, offset=0, max_num=1,
                     min_size=(200,200), max_size=(800,800), file_idx_offset=0)
